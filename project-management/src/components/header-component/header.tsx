...
export default function HeaderComponent() {
  return (
    <header class="top-0 left-0 w-full flex justify-between items-center bg-black p-4">
      ...
      <div class="flex gap-4">
        <button class="flex items-center gap-2 h-10 px-4 border-2 bg-gray-500 rounded-xs text-white">
          <PlusIconSvg />
